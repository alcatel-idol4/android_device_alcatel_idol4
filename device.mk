...
$(call inherit-product, vendor/tcl/idol4/idol4-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/wifi/WCNSS_cfg.dat:system/etc/WCNSS_cfg.dat \
    $(LOCAL_PATH)/wifi/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    $(LOCAL_PATH)/wifi/WCNSS_qcom_wlan_nv.bin:system/etc/wifi/WCNSS_qcom_wlan_nv.bin \
    $(LOCAL_PATH)/wifi/WCNSS_qcom_sdio_cfg.ini:system/etc/firmware/wlan/prima/WCNSS_qcom_sdio_cfg.ini \
